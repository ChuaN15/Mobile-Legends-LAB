...
public class HeroMageActivity extends AppCompatActivity {

    public void onBackPressed() {
        Intent intentt = new Intent(HeroMageActivity.this,HeroesActivity.class);
        ...
        HeroMageActivity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_mage);
    }
}
