...
public class DisplayQrCodeActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intentt = new Intent(DisplayQrCodeActivity.this,ProfileActivity.class);
        ...
        DisplayQrCodeActivity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://pd10.xyz/ChuaN/DisplayQRCode.php?namee=" + email);
    }
}
