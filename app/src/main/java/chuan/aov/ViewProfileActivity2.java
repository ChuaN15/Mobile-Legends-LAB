...
public class ViewProfileActivity2 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intentt = new Intent(ViewProfileActivity2.this,PopularActivity.class);
        ...
        ViewProfileActivity2.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email3 = email2.substring(22);
                    ...
                    if (success) {
                        ...
                        llAllComments.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intentt = new Intent(ViewProfileActivity2.this,ViewComments2Activity.class);
                                //here you put the data that you want to send back - could be Serializable/Parcelable, etc
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ViewProfileActivity2.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(ViewProfileActivity2.this);
