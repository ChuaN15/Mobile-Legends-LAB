...
public class ViewComments3Activity extends AppCompatActivity {

    @Override
    public void onBackPressed() {
        Intent intentt = new Intent(ViewComments3Activity.this,QrCodeProfileActivity.class);
        ...
        ViewComments3Activity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://pd10.xyz/ChuaN/displayusercomments.php?namee=" + namee);
    }
}
