...
public class HeroFighterActivity extends AppCompatActivity {

    public void onBackPressed() {
        Intent intentt = new Intent(HeroFighterActivity.this,HeroesActivity.class);
        ...
        HeroFighterActivity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_fighter);
    }
}
