...
public class ReportActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intentt = new Intent(ReportActivity.this,MenuActivity.class);
        ...
        ReportActivity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://pd10.xyz/ChuaN/report.php");
        ...
        webView.setWebViewClient(new WebViewClient() {
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (!url.contains("popular")) {
                    ...
                    Intent intent2 = new Intent(ReportActivity.this, ViewProfileActivity2.class);
    ...
    public void change() {
        ...
        if(_btnchange.getText() == "Chart View") {
            ...
            webView.loadUrl("http://pd10.xyz/ChuaN/report2.php");
        }
        else {
            _btnchange.setText("Chart View");
            webView.loadUrl("http://pd10.xyz/ChuaN/report.php");
