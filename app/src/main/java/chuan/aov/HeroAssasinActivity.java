...
public class HeroAssasinActivity extends AppCompatActivity {

    public void onBackPressed() {
        Intent intentt = new Intent(HeroAssasinActivity.this,HeroesActivity.class);
        ...
        HeroAssasinActivity.this.startActivity(intentt);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_assasin);
    }
}
